...
**توصيتي: A** — يحافظ على تمايزنا (الخصوصية)، والباك اند يخدم **auth + backup مشفّر + مقاييس مجهولة + rules + أدمن** فقط. (تفاصيل التصميم موجودة أصلاً في `AUTH_AND_ADMIN_SPEC.md`.)
...
> أغلب التصميم التفصيلي للمسار A **موثّق بالفعل** في `AUTH_AND_ADMIN_SPEC.md` — هذا المستند يجمّع الصورة الكاملة.

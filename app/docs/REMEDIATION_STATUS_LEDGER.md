...
- **Last updated:** Phase 1 complete (locally verified) — 2026-07-30
...
|---|---|---|---|---|---|
| MALI-001 | Crit | C+P | P2 | Not started | consent gating Closed; opt-in default = MALI-059n (P decision) |
...
| MALI-011 | High | C | P2 | Not started | native-queue = MALI-054n; actions-file = MALI-070n; DB-table coverage Closed |
...
| MALI-017 | High | C | P2 | Not started | 1-of-4 destructive paths guarded |
...
| MALI-046n | High | C | **P1** | Code complete · Locally verified | `enableMigrations:false` → pipeline owns user_version; 5 regression tests (file-based) |
...
| MALI-053n | High | C | P2 | Not started | sign-out flush omits child outboxes |
| MALI-054n | High | C | P2 | Not started | native queue survives sign-out (cross-user) |
...
| MALI-059n | Med | P | P2 | Decision required | consent opt-out default |
...
| MALI-070n | Low | C | P2 | Not started | actions-file/owner-null/announcement residue |
...
| P2 lifecycle/consent | 053n,054n,070n,011,017,001,059n | Not started |

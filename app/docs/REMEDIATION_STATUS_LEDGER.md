...
- **Last updated:** **Phase 7 Batch 1 CLOSURE — CI/test-harness/skip/lint/known-failure
  truthfulness — 2026-08-06.** Made `tools/ci_gates.sh` the SINGLE truthful canonical

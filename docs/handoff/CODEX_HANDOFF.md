...
> **اقرأ هذا الملف بالكامل قبل أي كود.** المرجعيات التفصيلية: `docs/specs/PRODUCT_SPEC.md` · `docs/specs/SAUDI_MARKET_SPEC.md` · `docs/specs/AUTH_AND_ADMIN_SPEC.md` · `DESIGN_SYSTEM.md` · `docs/design/WIREFRAMES.md` · `docs/plans/BUILD_PLAN.md` · النموذج: `prototype/onboarding-vibrant.html`.
...
- **التمايز:** عمق التلعيب + الخصوصية (on-device) + تصميم سعودي premium. (المنافس المباشر SAY — انظر `docs/plans/COMPETITIVE_ANALYSIS.md`.)
...
11. التزام حرفي بـ `DESIGN_SYSTEM.md` (Vibrant Fintech) وقواعد العمل `docs/specs/PRODUCT_SPEC.md §24/§25`.
...
- التفاصيل: `docs/specs/AUTH_AND_ADMIN_SPEC.md §4.6`.
...
المرجع الكامل في ملفات .md بجذر المستودع و docs/handoff/CODEX_HANDOFF.md. القواعد غير القابلة للتفاوض (CODEX_HANDOFF §2):

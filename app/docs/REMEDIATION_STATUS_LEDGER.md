...
- **Last updated:** **Phase 7 Batch 4 — hardening (2026-08-10): privacy surface,
  ...
  truthfulness reconciled and guarded.** Closure gate first-attempt green on
  committed tree `11727d81` (13/13 mandatory; bulk 1589 + crypto 24; arch guard
  6/6; offline deps policy). Remaining P7 evidence is external (signed builds,
...
| MALI-043 | Low | P+D | P7 | **Code complete · LV — brand=Qirsh/قِرش (Decision 1); unjustified NSLocation removed (B4-1/B4-7)** | canonical brand name (Mali vs Qirsh) |

...
| ANDROID | **BLOCKED_BY_ENVIRONMENT** — signing pipeline CLOSED (A2) and statically verified; compiling still needs a JDK + Android SDK, which this Mac lacks. Automatic SMS capture remains separately blocked by Play policy |

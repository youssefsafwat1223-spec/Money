...
- **Last updated:** **Phase 6 Batch 1 (encryption-key & backup-schema hygiene,
...
| P6 backup/DB/reliability | 058n,069n,073n,076n | **Batch 1 in progress.** MALI-058n (SQLCipher key + backup-schema hygiene) Code complete · Locally verified: raw key excluded from Drift/backup/restore/sync/export, restore column whitelist + fail-closed sanitization, idempotent legacy cleanup. Batches 2–6 (passphrase envelope, remote-backup reliability, DB connection lifecycle, restore/recovery matrix, closure) not started. 069n/073n/076n not started |

...
- **Last updated:** **Phase 6 Batch 3 (remote-backup state, safe publication,
  verified download) — 2026-08-06.** MALI-076n remote-backup portion + MALI-014
...
| MALI-069n | Med | C | P6 | Not started (deferred to **P6-Batch 4**) | conn leak + second-instance busy_timeout. **NOT addressed in Batch 2** — the Batch-2 finding list named it in error; it is DB connection-lifecycle work, explicitly deferred to Phase-6 Batch 4 (database connection lifecycle + concurrent same-file access). No connection ownership/isolate/busy_timeout/second-connection/cleanup behavior was changed in Batch 2 |
